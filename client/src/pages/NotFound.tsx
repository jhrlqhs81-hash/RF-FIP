        ...
        <CardContent className="pt-8 pb-8 text-center">
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="absolute inset-0 rounded-full animate-pulse" style={{ background: "var(--rf-red-bg)" }} />
              <AlertCircle className="relative h-16 w-16" style={{ color: "var(--rf-red-fg)" }} />
            </div>
          </div>
